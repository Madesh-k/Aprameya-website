      ...
      <div className="space-y-8 ">
        ...
        <div className="bg-purple-100 max-w-5xl w-full p-8 rounded-lg shadow-lg mx-auto relative flex items-center">
          ...
          >
            <p className="text-lg">
              ...
              @aprameya_in for helping me with my Instagram growth. Your advice
              and tips have really boosted my followers and made my post reach
              more people. My followers and reach is incredible now. I
              appreciate all the support you have provided in giving content
              ideas and looking forward to learning more from you.
            </p>
          </div>
        </div>
        ...
        <div className="bg-green-100 max-w-5xl w-full p-8 rounded-lg shadow-lg mx-auto relative flex items-center">
          ...
          >
            ...
            >
              I would like to appreciate my manager (Siesyana) from @aprameya_in
              and their team for building my Instagram page. I was having 3883
              followers when we started working together and it's been only 20
              days and I've gained 200+ followers, and 5L+ accounts have reached
              my profile...
            </p>
          </div>
        </div>
